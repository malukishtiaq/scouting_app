...
/// Fixed curved navigation bar that works correctly
class FixedCurvedNavigation extends StatefulWidget {
  final int currentIndex;
  final ValueChanged<int> onTap;
  final bool showTrending;

  const FixedCurvedNavigation({
    super.key,
  ...
  @override
  State<FixedCurvedNavigation> createState() => _FixedCurvedNavigationState();
}

class _FixedCurvedNavigationState extends State<FixedCurvedNavigation>
  ...
  @override
  void didUpdateWidget(FixedCurvedNavigation oldWidget) {
...
class FixedCurvePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final curveWidth = itemWidth * 0.7;
  ...
  @override
  bool shouldRepaint(FixedCurvePainter oldDelegate) {
