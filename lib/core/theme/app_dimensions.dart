/// Standardized Dimensions for Social Bee App
/// Use these dimensions throughout the entire app for consistency
class AppDimensions {
  // ===== SPACING =====
  ...
  static const double splashSpacing = 40.0;

  // ===== SHADOW =====
  static const double shadowBlur = 8.0;
  static const double shadowBlurLarge = 16.0;
  static const double shadowBlurXLarge = 24.0;
